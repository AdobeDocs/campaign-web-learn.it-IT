...
---
# Contribuire con un articolo

Apprezziamo i contributi sia dalla nostra community sia dai dipendenti Adobe esterni ai team di documentazione.
...
1. Fai clic su **Suggerisci una modifica** e invia una richiesta di pull (PR) con le modifiche nell&#39;interfaccia utente di GitHub.
   ...
   Per ulteriori informazioni, consulta la [Guida per i contributori della documentazione Adobe](https://experienceleague.adobe.com/docs/contributor/contributor-guide/introduction.html?lang=it).
...
I contributori della community possono utilizzare l’interfaccia utente di GitHub per apportare modifiche di base o eseguire il fork dell’archivio per i contributi rilevanti.

Per informazioni dettagliate, consulta la [Guida per i contributori della documentazione Adobe](https://experienceleague.adobe.com/docs/contributor/contributor-guide/introduction.html?lang=it).
...
Nell’archivio pubblico, alle richieste pull vengono assegnate etichette automatizzate che ci aiutano a gestire il flusso di lavoro e ad aggiornarti sullo stato della tua richiesta:

* **Change sent to author** (Modifica inviata all’autore): l’autore ha ricevuto una notifica della richiesta di pull in sospeso.
* **Ready-to-merge** (Pronta per l’unione): la richiesta pull è pronta per la revisione da parte del nostro team dedicato.
